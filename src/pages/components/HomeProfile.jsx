        ...
        <div className="container">
          ...
          <div className="author-info">
             <div className="author-info__imges">
                <img src="https://validthemes.net/site-template/markis/assets/img/team/1.jpg" alt="author image" />
             </div>
          </div>
          ...
          <div className="profile-info">
            ...
            <div className="top-info">
              <div className="bio">
                ...
                <Link href="#" className="bio__aLink">Follow</Link>
              </div>
            ...
            <div className="author-content">
                 <div className="author-content__buttons">
                    ...
                    <button className="author-content__button">Followers 120</button>
                 </div>
            </div>
